...
תוכל/י לאשר האם את/ה פנוי/ה?`,
  ...
  {
    key: "template_staff_replacement_check",
    label: "מצא מחליף — צלם ביטל",
    description: "ההודעה שנשלחת לכל מי שבתפקיד כשלוחצים '🔁 מצא מחליף' על אירוע (מהפאנל של האירוע או מרשימת השיבוץ). אם לא נשמרה — נשלחת תבנית בדיקת הזמינות הרגילה.",
    defaultValue: `היי! 🔁 התפנה לנו מקום ל{{role}} בתאריך {{event_date}} באולם {{venue}} ({{names}}).
פנוי/ה? אשמח לתשובה מהירה בקישור.`,
    variables: ["{{role}}", "{{event_date}}", "{{venue}}", "{{names}}"],
  },
  {
