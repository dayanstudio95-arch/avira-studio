...
import { BookImage, Plus, Edit, Trash2, Layers, Frame, Sparkles } from "lucide-react";
...
const CATALOGS = {
  ...
  covers: {
    ...
    singular: "כריכה",
    icon: Frame,
    emptyFields: { name: "", priceDelta: 0, active: true, sortOrder: 0 },
  },
  addons: {
    entity: "AlbumAddon",
    ...
    singular: "תוספת",
    icon: Sparkles,
    emptyFields: { name: "", price: 0, active: true, sortOrder: 0 },
  },
};
              ...
              <CardContent className="p-4 flex items-start justify-between gap-3">
                <div className="min-w-0">
                  ...
                  <div className="flex items-center gap-3 mt-2">
                    <span className="text-yellow-400 font-bold">{priceLabel(item)}</span>
